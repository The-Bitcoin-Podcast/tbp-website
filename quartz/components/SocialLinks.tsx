...
import { SocialLink } from "./types/landingPage"
...
const icons: Record<string, JSX.Element> = {
  ...
  rss: (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path d="M6.503 20.752c0 1.794-1.456 3.248-3.251 3.248c-1.796 0-3.252-1.454-3.252-3.248c0-1.794 1.456-3.248 3.252-3.248c1.795.001 3.251 1.454 3.251 3.248zm-6.503-12.572v4.811c6.05.062 10.96 4.966 11.022 11.009h4.817c-.062-8.71-7.118-15.758-15.839-15.82zm0-3.368C10.58 4.858 19.152 13.406 19.183 24h4.817C23.969 10.777 13.23.034 0 0v4.812z" />
    </svg>
  ),
}
...
export function SocialLinks({ links }: SocialLinksProps): JSX.Element {
  return (
    <div class="social-links">
      {links.map((link) => (
        <a key={link.platform} href={link.url} aria-label={link.ariaLabel}>
          {icons[link.platform]}
        </a>
      ))}
    </div>
